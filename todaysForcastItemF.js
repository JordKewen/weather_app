    ...
    render(){
        ...
        return(
            ...
            <View style={styles.dateAndTemp}>
                ...
                <Text style={{fontSize:21,marginLeft:77,width:49}}>{Math.round(this.props.todaysForcast.todaysForcast.tempMax)}º </Text>
                <Text style={{fontSize:19,marginRight:3,width:49}}>{Math.round(this.props.todaysForcast.todaysForcast.tempMin)}º </Text>
            </View>
